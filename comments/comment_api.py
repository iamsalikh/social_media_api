...
from database.commentservice import add_comment_db, delete_comment_db, change_comment_db, get_post_comments

# Создаем компонент
comment_router = APIRouter(prefix='/comment', tags=['Работа с комментaрием'])
